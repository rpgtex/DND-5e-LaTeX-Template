...
\begin{table*}
  \begin{dndtable}[XXX]
    \textbf{Color}           & \textbf{Alias}                            & \textbf{Description} \\
    \verb=PHBCharacterColor= & \verb=PHBLightGreen=                      & Light green used in PHB Part 1 \\
    \verb=PHBRulesColor=     & \verb=PHBLightCyan=                       & Light cyan used in PHB Part 2 \\
    \verb=PHBMagicColor=     & \verb=PHBMauve=                           & Pale purple used in PHB Part 3 \\
    \verb=PHBAppendixColor=  & \verb=PHBTan=                             & Light brown used in PHB appendix \\
    \verb=DMGWorldColor=     & \verb=DMGLavender=                        & Pale purple used in DMG Part 1 \\
    \verb=DMGAdventureColor= & \verb=DMGCoral=                           & Orange-pink used in DMG Part 2 \\
    \verb=DMGRulesColor=     & \verb=DMGSlateGray= (\verb=DMGSlateGrey=) & Blue-gray used in PHB Part 3 \\
    \verb=DMGAppendixColor=  & \verb=DMGLilac=                           & Purple-gray used in DMG appendix \\
  \end{dndtable}
...
\begin{verbatim}
\settrimcolor{DMGAdventureColor}
\begin{dndtable}[cX]
  \textbf{d8} & \textbf{Item} \\

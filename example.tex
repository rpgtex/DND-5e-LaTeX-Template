...
\begin{lstlisting}
\subsection{\DndArea{Village of Hommlet}}
This is the village of hommlet. \DndAreaRef{Foo's Castle} lies on the other side.

\subsubsection{\DndSubArea{Inn of the Welcome Wench}}
Inside the village is the inn of the Welcome Wench.

\subsubsection{\DndSubArea{Blacksmith's Forge}}
There's a blacksmith in town, too.

\subsection{\DndArea{Foo's Castle}}
This is Foo's home, a hovel of mud and sticks.

\subsubsection{\DndSubArea{Moat}}
This ditch has a board spanning it.

\subsubsection{\DndSubArea{Entrance}}

...
\begin{DndMonster}[float*=t, width=\textwidth]{Monster Foo}
  \begin{multicols}{2}
    ...
    \begin{DndMonsterAction} {Spellcasting}
    ...
    \begin{DndMonsterAction} {Multiattack}
    ...
    \DndMonsterAttack[
      ...
      %range=20/60,
      %targets=one target,
      dmg=\DndDice{1d4+1},%dmg=\dice{1d4},
      %dmg-type=piercing,
      %plus-dmg=,
      %plus-dmg-type=,
      %or-dmg=,
    ...
    \DndMonsterLegendaryAction{Move}{The foo moves up to his speed.}
    \DndMonsterLegendaryAction{Attack}{The foo makes a melee attack.}
    \DndMonsterLegendaryAction{Create Contract (Costs 3 Actions)}{The foo presents a contract in a language it knows and waves it in the face of a creature within 10 feet. The creatue must make a DC 10 Intelligence saving throw. On a failure, the creature is incapacitated until the start of the foo's next turn. A creature who cannot read the contract's language has advantage on this saving throw.}

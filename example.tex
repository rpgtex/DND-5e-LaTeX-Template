...
\begin{itemize}
  \item Use \lstinline!\DndSetThemeColor[<color>]! to set \lstinline!themecolor!, \lstinline!commentcolor!, \lstinline!paperboxcolor!, and \lstinline!tablecolor! to a specific color.

...
Subsubsections are the furthest division of information that still has a header. Below this level, headers are displayed inline.

\paragraph{Paragraph}
The paragraph format is seldom used.
...
\begin{monsterbox}{Monster Foo}
  ...
  \details[% If you want to use commas in these sections, enclose the description in braces.
    %savingthrows = {Str \DndPlus{0}, Dex \DndPlus{0}, Con \DndPlus{0}, Int \DndPlus{0}, Wis \DndPlus{0}, Cha \DndPlus{0}},
    %skills = {Acrobatics \DndPlus{0}, Animal Handling \DndPlus{0}, Arcana \DndPlus{0}, Athletics \DndPlus{0}, Deception \DndPlus{0}, History \DndPlus{0}, Insight \DndPlus{0}, Intimidation \DndPlus{0}, Investigation \DndPlus{0}, Medicine \DndPlus{0}, Nature \DndPlus{0}, Perception \DndPlus{0}, Performance \DndPlus{0}, Persuasion \DndPlus{0}, Religion \DndPlus{0}, Sleight of Hand \DndPlus{0}, Stealth \DndPlus{0}, Survival \DndPlus{0}},
  ...
  \begin{monsteraction}[Innate Spellcasting]
    Foo's spellcasting ability is Charisma (spell save DC 12, \DndPlus{4} to hit with spell attacks). It can innately cast the following spells, requiring no material components:
    \medskip
  ...
  \begin{monsteraction}[Spellcasting]
    Foo is a 3rd-level spellcaster. Its spellcasting ability is Charisma (spell save DC 12, \DndPlus{4} to hit with spell attacks). It has the following sorcerer spells prepared:
    \medskip
...
\begin{table*}[b]%
  \caption{Colors supported by this package}\label{tab:colors}
...
The |commentbox|, |dndtable|, |paperbox|, and |quoteboxcolor| accept an optional color argument to set the color for a single instance.
